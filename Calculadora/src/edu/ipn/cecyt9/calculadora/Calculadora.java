...
public class Calculadora extends JFrame {
    ...
    public Calculadora() {
        ...
        nuevoBotonOperacion("x^n");
        nuevoBotonOperacion("Raíz Cuadrada");
        nuevoBotonOperacion("Sen");
        nuevoBotonOperacion("Tan");
        nuevoBotonOperacion("Radianes");
    ...
    private void calcularResultado() {
        if (operacion.equals("+")) {
            ...
            resultado *= new Double(pantalla.getText());
        } else if (operacion.equals("x^n")) {
            resultado = Math.pow(resultado, (new Double(pantalla.getText())));
        } else if (operacion.equals("Raíz Cuadrada")) {
            ...
            resultado = Math.log((new Double(pantalla.getText())));
        } else if (operacion.equals("Radianes")) {
            resultado = Math.toRadians((new Double(pantalla.getText())));
        }
